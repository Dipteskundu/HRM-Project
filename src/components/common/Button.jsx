...
const VARIANTS = {
  ...
  success:   'bg-emerald-600 text-white shadow-sm hover:bg-emerald-700 focus:ring-emerald-500/40',
  dark:      'bg-emerald-500 text-white shadow-sm hover:bg-emerald-600 focus:ring-emerald-500/40',
}
